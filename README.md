...
CSCI-103 (Introduction to Programming) at USC covers foundational programming concepts in C++, including variables, control flow, functions, arrays, pointers, and an introduction to classes and object-oriented design. These projects go beyond the standard coursework by implementing multi-class inheritance hierarchies, dynamic memory allocation, file I/O, and STL containers.
